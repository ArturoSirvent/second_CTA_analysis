...
opciones_filtros=[
    [[12,16],[32,64],[64,12]],
    [[32,64],[128,256],[128,64],[64,32]],
    [[64,128],[128,256],[256,128],[64,32]]
]
...
for i,arch in enumerate(opciones_filtros):
    ...
    for k in range(n):
        ...
        list_runs=new_create_main_list_runs([13,75,34,34,34,34,34],chose_runs)
        with open(f"{base_dir}/automat/logs/{file_number}_data_control.txt","a") as registro:
        ...
        hist=modelo.fit(x=x_train_list,y=y_train_list,epochs=60, validation_data=(x_test_list,y_test_list),batch_size=64)            
